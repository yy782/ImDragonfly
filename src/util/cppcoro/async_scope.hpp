...
#ifndef COROUTINE_ASYNC_SCOPE_HPP_INCLUDED
#define COROUTINE_ASYNC_SCOPE_HPP_INCLUDED
 ...
 public:
  ...
  void spawn(AWAITABLE&& awaitable) {
    [](async_scope* scope, std::decay_t<AWAITABLE> awaitable) -> oneway_task {
      ...
      auto decrementOnCompletion =
          on_scope_exit([scope] { scope->on_work_finished(); });
