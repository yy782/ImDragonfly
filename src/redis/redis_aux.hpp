...
class ListObject {
 public:
  ...
  void PushFront(const std::string& value) { data_.push_front(value); }
  ...
  std::deque<std::string>& Data() { return data_; }

  const std::deque<std::string>& Data() const { return data_; }
...
class SetObject {
 public:
  ...
  size_t Remove(const std::string& value) { return data_.erase(value); }
...
class ZSetObject {
 public:
  ...
  size_t Length() const { return skip_list_.Length(); }

  bool Empty() const { return skip_list_.Empty(); }

  std::vector<std::pair<std::string, double>> Range(int64_t start,
                                                    int64_t end) const {
  ...
  std::vector<std::pair<std::string, double>> RevRange(int64_t start,
                                                       int64_t end) const {
    std::vector<std::pair<std::string, double>> result;
