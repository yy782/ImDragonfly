...
//     *registry
//         << CI{"MULTI", kInvalidKeysStart, 0,
//         kInvalidKeysOffset}.SetHandler(&MultiFamily::Multi)
//         << CI{"EXEC", kInvalidKeysStart, 0,
//         kInvalidKeysOffset}.SetHandler(&MultiFamily::Exec)
//         << CI{"DISCARD", kInvalidKeysStart, 0,
//         kInvalidKeysOffset}.SetHandler(&MultiFamily::Discard)
//         << CI{"WATCH", 1, kInvalidKeysNum, 1}.SetHandler(&MultiFamily::Watch)
//         << CI{"UNWATCH", kInvalidKeysStart, 0,
//         kInvalidKeysOffset}.SetHandler(&MultiFamily::Unwatch)
//         ;
// }
