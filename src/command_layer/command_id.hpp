...
class CommandId {
 public:
  CommandId(const char* name, size_t keys_start, size_t keys_nums,
            size_t keys_offset, uint32_t opt_mask = 0);

  std::string_view name() const { return name_; }

  size_t keys_nums() const { return keys_nums_; }

  size_t keys_offset() const { return keys_offset_; }

  size_t keys_start() const { return keys_start_; }
  ...
  size_t GetFamily() const { return family_; }
